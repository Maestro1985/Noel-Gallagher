...
<body>
   ...
   <center> <h3> Gym reviews</h3></center>
    <center> <p>Read Townfit's latest reviews </p></center>
    <?php
...
echo '<div class="row">'; 
echo '<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb40">';
echo '<div class="testimonial-block">';
echo '<div class="testimonial-icon"><i class="fas fa-quote-left"></i></div>';
...
echo '<br>';
        ...
        echo '<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt20">';
echo '';
echo '<button class="btn btn-default" type="submit" name="sub"><a href="addreview.php">Add review</button>';
echo '</div>';
echo '</div>';
echo '</div>';
echo '</form>';
