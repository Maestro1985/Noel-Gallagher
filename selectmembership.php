...
<body>
    ...
    $sql="INSERT INTO `Membership`( `Name`, `Address`,`City`,`Postcode`,`Phone`,`Email`,`Contract type`) VALUES ('".$_POST['Name']."','".$_POST['Address']."','".$_POST['City']."','".$_POST['Postcode']."','".$_POST['Phone']."','".$_POST['Email']."','".$_POST['state']."')";
    


$result=$conn->query($sql);
if ($result)
    echo "Membership recorded";
else
